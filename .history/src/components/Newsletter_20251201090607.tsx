  ...
  return (
    <section className="py-16 lg:py-20 bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-600 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-300/30 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Subscribe to our newsletter for expert advice, seasonal maintenance tips, 
            and exclusive offers from top-rated professionals.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-5 py-4 rounded-xl bg-white/95 text-slate-800 placeholder-slate-400 
                border-2 border-transparent focus:border-white focus:outline-none shadow-lg text-sm"
            ...
            <button
              ...
              className={`px-6 py-4 rounded-xl font-semibold text-sm shadow-lg transition-all 
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-2 p-4 rounded-2xl 
              ...
              <p className="text-white/90 text-sm font-medium">No spam, ever</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 p-4 rounded-2xl 
              ...
              <p className="text-white/90 text-sm font-medium">Weekly digest</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 p-4 rounded-2xl 
              ...
              <p className="text-white/90 text-sm font-medium">Unsubscribe anytime</p>
            </div>
