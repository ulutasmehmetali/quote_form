    ...
    <section className="py-16 lg:py-20 bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-600 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center">
          ...
          {/* SUPER SMALL CLEAN MINI CARDS — SIDE BY SIDE */}
          <div className="mt-10 flex items-center justify-center gap-3 flex-wrap">

            {/* Card 1 */}
            <div className="flex flex-col items-center gap-1 p-2 rounded-xl bg-white/10 
              backdrop-blur-md border border-white/20 shadow-sm w-[85px]">
              <div className="w-6 h-6 flex items-center justify-center rounded-lg bg-white/20 text-white">
